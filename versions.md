...
#### Version 0.5.2, rev. 37 (19 August 2018)

Commit: latest on master

* Adds a version number to the specification and a link to the (newly-written) changelog

#### Version 0.5.2, rev. 36 (14 August 2018)

Commit: b4fb39c8a62077a0cdd11a930b64ae2bca08999e

* Adds an index to the specification

#### Version 0.5.2, rev. 35 (28 July 2018)

Commit: d9936fba051f11c01b3deda6e36f65c3f5addc52

* Adds a note that mandates overflows in the calculation of the effective address for `jumptable` to result in fatal
  errors

#### Version 0.5.1, rev. 34 (22 September 2017)

Commit: c2afec8713dd13f95f74c8c685008e455d2f2965

* Fixes various writing errors (grammar mistakes, unclear sentences, etc.) throughout the specification

#### Version 0.5.1, rev. 33 (9 March 2017)

Commit: e1f011bce4c5f3f3ef02d1bf5d71f5904fbda42b

* Fixes a formatting error in the description of `longmulacum`

#### Version 0.5.1, rev. 32 (5 March 2017)

Commit: acd7fb099e1fd280e219ea1a455f14f67ab0d2d3
...
#### Version 0.5.0, rev. 31 (14 February 2017)

Commit: 10a6845f2a6e530844377e908874d1665b9b9c54

* Adds 64-bit arithmetic instructions

#### Version 0.4.0, rev. 30 (5 February 2017)

Commit: 5c7370006a036bc2eedae8490fb97d0d328f1844

* Fixes another grammatical mistake in the description of instructions that read from the file buffer

#### Version 0.4.0, rev. 29 (5 February 2017)

Commit: b5284bb6ad6270203604ab9877e529082e85fbd3

* Fixes a grammatical mistake in the description of instructions that read from the file buffer

#### Version 0.4.0, rev. 28 (5 February 2017)

Commit: a562f943830f3d0b11a7ab4d54c839c9e7492aa0

* Adds the `getfilebyte`, `getfilehalfword`, `getfileword` and `getvariable` instructions

#### Version 0.3.0, rev. 27 (30 January 2017)

Commit: 5abca7bf6a391f020ace1a35a6f2489bae73f5e5

* Fixes several grammatical errors in the description of `checksha1`

#### Version 0.3.0, rev. 26 (14 January 2017)

Commit: 09ca5dfc562e2610ee83ca8e4cac464ecb28d8b7

* Fixes formatting errors in the description of the bit-shifting instructions

#### Version 0.3.0, rev. 25 (14 January 2017)

Commit: 1062993bfaac708ba449b4900707b8f7d9b0fef4

* Fixes a formatting error in the description of `getstacksize`

#### Version 0.3.0, rev. 24 (10 January 2017)

Commit: 8eff45b9cd3bd9cdb8c08145b1992eb3dcf80dc5

* Improves the formatting of the table listing the bit-shifting instructions

#### Version 0.3.0, rev. 23 (10 January 2017)

Commit: d41003113e8456b7cb45859f5ca3ffd96c21b76d

* Fixes a grammatical error in the description of `rotateleft`

#### Version 0.3.0, rev. 22 (10 January 2017)

Commit: 131d484579cd82c2238c08d2fddbaa8ad755a872

* Adds the `setstacksize` and `getstacksize` instructions, and the bit-shifting instructions

#### Version 0.2.2, rev. 21 (2 January 2017)

Commit: f816e066a69b00497f05755f37caeed1b32576c8

* Fixes a few typos and similar errors

#### Version 0.2.2, rev. 20 (12 December 2016)

Commit: 15f3ca40120e10add4b773e58d23aa629922d804

* Adds notes clarifying the interaction of `poppos` and the `seek` family of instructions with a locked current file
  pointer

#### Version 0.2.2, rev. 19 (12 December 2016)

Commit: 82f51ba1bf867c7bae0011a73c04fc18732147ee

* Updates `stackread` and `stackwrite` to accept negative stack positions

#### Version 0.2.1, rev. 18 (12 December 2016)

Commit: 7fd8f7aded664d92f7f226def3457eea065ca1ce

* Amends the description of `bufchar` to require engines to accept spaces

#### Version 0.2.0, rev. 17 (12 December 2016)

Commit: 4ad5af7bc9ea151e55d6817d50edf65ba8145074
...
#### Version 0.1.1, rev. 16 (2 December 2016)

Commit: 15b63746acecadd7569e12944a8480b79545c2e4

* Fixes an error in the argument lists for the `truncate` instruction

#### Version 0.1.0, rev. 15 (29 November 2016)

Commit: 454cd7d24c05566f86de599f4a707b3253986acb

* Fixes a formatting error in the description of the `bsppatch` instruction

#### Version 0.1.0, rev. 14 (29 November 2016)

Commit: 750ab28bff50c928ab8cdda694fcba54430f8238

First complete version of the specification.

* Adds a description for the `bsppatch` instruction

#### Version 0.0.8, rev. 13 (29 November 2016)

Commit: fdd6daf6024efd67759ca965247bd2df502d37d9

* Further improves the wording in the description of the `ipspatch` instruction

#### Version 0.0.8, rev. 12 (29 November 2016)

Commit: 575b7e90d5bff4c8cb62d2f3e984a0d587016736

* Fixes the wording in the description of the `ipspatch` instruction

#### Version 0.0.8, rev. 11 (29 November 2016)

Commit: 86c30c5fdca1935935da4d7ea87b73f7f4765ad8

* Updates the argument lists for the `ipspatch` instruction
* Adds descriptions for `ipspatch` and `checksha1`

#### Version 0.0.7, rev. 10 (28 November 2016)

Commit: d6e900b07f8fe0f8d962eaabc6b0ee9985d13428

* Fixes grammatical mistakes in the descriptions of the `pushpos` and `poppos` instructions

#### Version 0.0.7, rev. 9 (28 November 2016)

Commit: 79cff74a8fba55e587ead3e2dffc7cb9c6ff9d5d
...
#### Version 0.0.6, rev. 8 (26 November 2016)

Commit: 9f6a712692ef9303b37be36ea9e55ef589f27fe1

* Adds descriptions for instructions that read from and write to the file buffer

#### Version 0.0.5, rev. 7 (26 November 2016)

Commit: a143d24f3736edfe3e9ee91c14efd5bc4d923112

* Fixes the formatting of a section header

#### Version 0.0.5, rev. 6 (26 November 2016)

Commit: 97da86ec40c60c46d16971ebc8719313b398d84d
...
#### Version 0.0.5, rev. 5 (26 November 2016)

Commit: a8fb59ee3e9a6ae3fbb1ec3d374122e56f1770a1

* Adds descriptions for advanced stack operations and instructions that read values from patch space

#### Version 0.0.4, rev. 4 (26 November 2016)

Commit: 064a7cf95efae472b325759de22071b522c7bea8

* Updates the argument lists for `menu` and `jumptable`
* Adds descriptions for conditional jumps, `menu`, `print`, `exit` and `jumptable`

#### Version 0.0.3, rev. 3 (26 November 2016)

Commit: 87d74cf3669c1a4040887aa03e41c728226b5297

* Adds descriptions for arithmetic instructions, basic control flow, `push` and `pop`

#### Version 0.0.2, rev. 2 (26 November 2016)

Commit: 2f26f24664bd5a6e8b204f9e1e7b9a2d6a522e79
